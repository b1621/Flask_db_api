...
def insert_cve(id, published_date, last_modified, description, part, vendor, product, basescore, sourceidentifier):
    ...
    if db is None:
        ...
        cursor = db.cursor()
        cursor.execute("INSERT INTO cve(id,published_date,last_modified,description,part,vendor,product,sourceidentifier,basescore) VALUES (?,?,?,?,?,?,?,?,?) ",
                       (id, published_date, last_modified, description, part, vendor, product, sourceidentifier, basescore))
    return
